...
MODES = (
    "analyze", "reference", "both", "batch", "folder", "album",
    "codecs", "streaming", "fixes", "repairs", "history",
    "export", "all", "complete", "doctor",
)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--no-previews", action="store_true", help="Analyze codec/streaming readiness without rendering previews.")
